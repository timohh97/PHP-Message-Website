...
$database = new mysqli("localhost","timohh97_admin1","449060data","timohh97_phpdata");
    ...
    if(password_verify($passwordFromInput,$rowArray[2])==true)
    {
      echo "<script> alert('Login successful!') </script>";
           echo "<script> window.location = 'https://www.message.timoschessl.com/loginSuccess.php'</script>";
    }
    else {
          echo "<script> alert('Wrong password!') </script>";
           echo "<script> window.location = 'https://www.message.timoschessl.com/index.html'</script>";
    }
}
else {
